...
Module PublicFunctions
    ...
    Public Function GetConnection() As SqlConnection
        Return New SqlConnection(String.Format("Server={0};Initial Catalog={1};User ID={2};Password={3};Pooling={4};", My.Settings.Server, My.Settings.Database, My.Settings.Username, DecryptString(My.Settings.Password), If(My.Settings.Pooling, "true", "false")))
    End Function
    Sub ReleaseMemory()
        Try
            GC.Collect()
